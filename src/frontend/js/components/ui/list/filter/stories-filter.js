...
const StriesFilter = React.createClass({
    propTypes: {
                ...
                >
                    <Grid verticalAlign='bottom'>
                        ...
                        <Grid.Column width={ 5 } textAlign='right'>
                            <Divider vertical />
                            <Button as='a' content='New' labelPosition='right' icon='add' color='green' onClick={()=>{browserHistory.push('/story/create')}} />
                        </Grid.Column>
                    </Grid>
                </Form>
            </Segment>
