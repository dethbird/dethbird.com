...
const UsersFilter = React.createClass({
    propTypes: {
            ...
            <Segment>
                ...
                >
                    <Grid verticalAlign='bottom'>
                        <Grid.Column width={ 4 } >
                            <Form.Input label="Username" placeholder="Username" name="username" type="text" onChange={ handleFieldChange } value={ changedFields.username || ''}/>
                        </Grid.Column>
                        <Grid.Column width={ 4 } >
                            <Form.Field>
                                <label>Order</label>
